...
using EPiBootstrapArea.SampleWeb.Models.Blocks;
...
namespace EPiBootstrapArea.SampleWeb.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(EPiFormPage) }, // Pages we can create under the start page...
